view: mpa_f_campaign_membership_agg_week_campaign {
  sql_table_name: simon12_warehouse.mpa_f_campaign_membership_agg_week_campaign ;;
  ...
  dimension: campaign_membership_agg_week_campaign_key {
    type: number
    sql: ${TABLE}.campaign_membership_agg_week_campaign_key ;;
  }
