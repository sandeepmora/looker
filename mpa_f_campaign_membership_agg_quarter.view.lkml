view: mpa_f_campaign_membership_agg_quarter {
  sql_table_name: simon12_warehouse.mpa_f_campaign_membership_agg_quarter ;;

  dimension: campaign_membership_agg_quarter_key {
    type: number
    sql: ${TABLE}.campaign_membership_agg_quarter_key ;;
  }
