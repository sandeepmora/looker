view: mpa_f_campaign_membership_agg_date {
  sql_table_name: simon12_warehouse.mpa_f_campaign_membership_agg_date ;;

  dimension: campaign_membership_agg_date_key {
    type: number
    sql: ${TABLE}.campaign_membership_agg_date_key ;;
  }
