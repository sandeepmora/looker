view: mpa_f_email_activity_agg_email_sent_month {
  sql_table_name: simon12_warehouse.mpa_f_email_activity_agg_email_sent_month ;;
  ...
  dimension: email_activity_agg_email_sent_month_key {
    type: number
    sql: ${TABLE}.email_activity_agg_email_sent_month_key ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [sent_year_quarter_name, sent_year_month_name]
  }
}
