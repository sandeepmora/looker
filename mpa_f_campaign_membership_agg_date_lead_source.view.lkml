view: mpa_f_campaign_membership_agg_date_lead_source {
  sql_table_name: simon12_warehouse.mpa_f_campaign_membership_agg_date_lead_source ;;

  dimension: campaign_membership_agg_date_lead_source_key {
    type: number
    sql: ${TABLE}.campaign_membership_agg_date_lead_source_key ;;
  }
