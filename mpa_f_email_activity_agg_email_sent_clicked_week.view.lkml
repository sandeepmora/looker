view: mpa_f_email_activity_agg_email_sent_clicked_week {
  sql_table_name: simon12_warehouse.mpa_f_email_activity_agg_email_sent_clicked_week ;;
  ...
  dimension: email_activity_agg_email_sent_clicked_week_key {
    type: number
    sql: ${TABLE}.email_activity_agg_email_sent_clicked_week_key ;;
  }
