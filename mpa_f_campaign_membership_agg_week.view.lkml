view: mpa_f_campaign_membership_agg_week {
  sql_table_name: simon12_warehouse.mpa_f_campaign_membership_agg_week ;;

  dimension: campaign_membership_agg_week_key {
    type: number
    sql: ${TABLE}.campaign_membership_agg_week_key ;;
  }
