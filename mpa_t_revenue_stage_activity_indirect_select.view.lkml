view: mpa_t_revenue_stage_activity_indirect_select {
  sql_table_name: simon12_warehouse.mpa_t_revenue_stage_activity_indirect_select ;;
  ...
  dimension: to_activity_from_stage_source_id {
    type: string
    sql: ${TABLE}.to_activity_from_stage_source_id ;;
  }
