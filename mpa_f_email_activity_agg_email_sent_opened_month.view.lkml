view: mpa_f_email_activity_agg_email_sent_opened_month {
  sql_table_name: simon12_warehouse.mpa_f_email_activity_agg_email_sent_opened_month ;;
  ...
  measure: count {
    type: count
    drill_fields: [sent_year_quarter_name, sent_year_month_name, opened_year_quarter_name, opened_year_month_name]
  }
}
