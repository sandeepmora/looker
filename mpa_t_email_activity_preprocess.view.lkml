view: mpa_t_email_activity_preprocess {
  sql_table_name: simon12_warehouse.mpa_t_email_activity_preprocess ;;
  ...
  dimension: temp_email_activity_preprocess_key {
    type: number
    sql: ${TABLE}.temp_email_activity_preprocess_key ;;
  }
