view: mpa_f_email_activity_agg_email_sent_quarter {
  sql_table_name: simon12_warehouse.mpa_f_email_activity_agg_email_sent_quarter ;;
  ...
  dimension: email_activity_agg_email_sent_quarter_key {
    type: number
    sql: ${TABLE}.email_activity_agg_email_sent_quarter_key ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [sent_year_quarter_name]
  }
}
